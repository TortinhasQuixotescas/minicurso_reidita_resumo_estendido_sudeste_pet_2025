...
\insereResumo{%
    Este trabalho apresenta o minicurso ``\gls{titulo_do_minicurso}'', elaborado pelo \glsxtrshort{getsi} da \glsxtrshort{ufjf}.
...
{%
    This paper presents the workshop ``\gls{titulo_do_minicurso}'', developed by the \glsxtrshort{getsi} of \glsxtrshort{ufjf}.
